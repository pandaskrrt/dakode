      ...
      >
        <div class="flex items-center gap-4">
          ...
          <div class="hidden md:flex h-9 items-center gap-1 rounded-full border border-gray-200/60 bg-white/40 p-1 backdrop-blur-sm dark:border-zinc-800/60 dark:bg-zinc-950/40">
            <a href="/projects" class="flex h-full items-center rounded-full px-4 text-sm font-medium transition duration-200 {currentPath === '/projects' ? 'bg-white shadow text-gray-950 dark:bg-zinc-800 dark:text-white' : 'text-gray-600 hover:text-gray-950 dark:text-zinc-400 dark:hover:text-white'}">
              Project
            </a>
